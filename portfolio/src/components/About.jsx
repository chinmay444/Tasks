...
function About() {
  return (
    <>
      <section className="mt-10 p-8 bg-white rounded-lg shadow-xl">
        <div className="max-w-screen-lg mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:space-x-6">
            <img
              ...
              className="w-48 h-48 rounded-full shadow-lg mb-6 md:mb-0"
            />
            <div>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Hello! I'm <span className="font-bold text-blue-600">Chinmay Chaudhari</span>, a passionate Software Engineer with over 5 years of experience in the industry. My journey in software development began during my college days, where I discovered my love for coding and problem-solving.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
